...
/**
 * Stores and returns the plugin's admin page hook suffixes, so the CSS can be
 * loaded only on these two pages (see crystalex_enqueue_admin_styles).
 *
 * @param array|null $set If an array is passed, it replaces the stored value.
 * @return array The currently stored hook suffixes.
 */
...
/**
 * CSS for the plugin's admin page (modern, full width).
 * Loaded via wp_add_inline_style rather than a hardcoded <style> tag.
 *
 * @return string
 */
...
/**
 * Loads the plugin's admin page CSS, but only on its own two pages.
 *
				...
				<form method="post">
					...
					<div class="cx-toggle-row">
						<div class="cx-toggle-text">
							<strong><?php esc_html_e( '"Sale" badge', 'crystalex-badges' ); ?></strong>
							<p><?php esc_html_e( 'Automatically add/remove the "Sale" tag based on the product\'s sale price', 'crystalex-badges' ); ?></p>
						</div>
					...
					<div class="cx-toggle-row">
						<div class="cx-toggle-text">
							<strong><?php esc_html_e( '"Out of stock" badge', 'crystalex-badges' ); ?></strong>
							<p><?php esc_html_e( 'Automatically add/remove the "Out of stock" tag based on the product\'s stock status', 'crystalex-badges' ); ?></p>
						</div>
						<label class="cx-switch">
				...
				<table class="widefat">
					...
					<tbody>
						<tr>
							...
							<td>
								<?php if ( $sale_enabled ) : ?>
									<span class="cx-pill cx-pill-on"><?php esc_html_e( 'Enabled', 'crystalex-badges' ); ?></span>
								<?php else : ?>
									<span class="cx-pill cx-pill-off"><?php esc_html_e( 'Disabled', 'crystalex-badges' ); ?></span>
								<?php endif; ?>
							</td>
						</tr>
						<tr>
