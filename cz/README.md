...
> Toto je **česká** varianta pluginu — popisky v administraci, automaticky generované tagy (`Sleva`, `Vyprodáno`) i komentáře ve zdrojovém kódu jsou v češtině. Funkčně identická **anglická** varianta je ve složce [`../en`](../en). Přehled celého repozitáře najdeš v [README.md](../README.md) v kořeni repa. Instaluj vždy jen jednu variantu na daný web — obě definují stejné názvy PHP funkcí a nemohou být aktivní současně.
